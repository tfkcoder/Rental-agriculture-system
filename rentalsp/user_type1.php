                                                    ...
                                                    <?php
                                                               ...
                                                               try{
                                                                    ...
                                                                    foreach($stmt as $row){
                                                                        ...
                                                                        $active = (!$row['status1']) ?'<span class="pull-right"><a href="#activate" class="status activate" title="Activate user"  data-toggle="modal" data-id="'.$row['user_id'].'"><i class="fa fa-check-square-o"></i></a></span>' : '';
