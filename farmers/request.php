                                    ...
                                    <div class="row">
                                        <div class="col-5 col-md-4">
                                            <div class="icon-big text-center icon-warning">
                                                ...
                                                <i class="fa fa-ban text-warning fa-4x" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                ...
                                <div class="container-fluid">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="h5 text-dark text-center">Rental Request form</div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="section">
                                                <div class="container-fluid">
                                                    <form method="POST" action="request_add.php"
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input type="hidden" class="form-control" name="status1"
                                                                id="formId1" value="0">

                                                        </div>
                                                        <div class="form-floating mb-3">

                                                            <input type="hidden" class="form-control" name="types"
                                                                id="formId1" value="0">
                                                            ...
                                                            <?php
                                                               ...
                                                               try{
                                                                    ...
                                                                    foreach($stmt as $row){
                                                                        ...
                                                                        $types = ($row['types'])? '<div  class="p  rounded-pill w-40 text-center  text-success">Yes </div>' : '<span class="label div text-danger rounded-pill w-40 text-center "> No </span>';
